...
class CheckpointStore(ABC):
    ...
    async def update_checkpoint(self, checkpoint):
        ...
        consumer group in the chosen storage service. Checkpoint information should include:

            - `fully_qualified_namespace`(str): The fully qualified namespace that the event hub belongs to.
             The format is like "<namespace>.servicebus.windows.net".
            - `eventhub_name`(str): The name of the specific Event Hub the ownership are associated with, relative to
             the Event Hubs namespace that contains it.
        ...
        :param dict checkpoint: The checkpoint information.
        :rtype: None
        """
